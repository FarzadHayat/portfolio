...
Go Home
</a> <a href="/#projects" class="btn btn-outline rounded-full gap-2"> ${renderComponent($$result2, "FolderOpen", FolderOpen, { "class": "size-5" })}
View Projects
...
}, "/home/farzad/portfolio/src/pages/404.astro", void 0);

const $$file = "/home/farzad/portfolio/src/pages/404.astro";
const $$url = "/404";
