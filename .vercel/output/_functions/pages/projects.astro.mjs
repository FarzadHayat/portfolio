...
const $$Index = createComponent(async ($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${renderComponent($$result, "Layout", $$Layout, { "title": "Projects - Bloomfolio", "description": "Explore my latest projects and work" }, { "default": async ($$result2) => renderTemplate` ${maybeRenderHead()}<main class="max-w-6xl mx-auto px-6 py-28"> <!-- Header --> <div class="text-center mb-16"> <h1 class="text-5xl font-bold mb-4">Projects</h1> <p class="text-xl text-base-content/70">
...
}, "/home/farzad/portfolio/src/pages/projects/index.astro", void 0);

const $$file = "/home/farzad/portfolio/src/pages/projects/index.astro";
const $$url = "/projects";
