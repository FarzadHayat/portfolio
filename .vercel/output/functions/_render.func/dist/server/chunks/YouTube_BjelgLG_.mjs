...
const $$YouTube = createComponent(($$result, $$props, $$slots) => {
  ...
  return renderTemplate`${maybeRenderHead()}<div class="youtube-embed my-6 rounded-xl overflow-hidden aspect-video"> <iframe${addAttribute(embedUrl, "src")}${addAttribute(`YouTube video player - ${videoId}`, "title")} width="100%" height="100%" allow="accelerometer; autoplay; clipboard-write; encrypted-media; gyroscope; picture-in-picture" allowfullscreen loading="lazy" class="w-full h-full"></iframe> </div>`;
}, "/home/farzad/portfolio/src/components/YouTube.astro", void 0);
