...
import { c as createLucideIcon, $ as $$Layout, H as House } from '../chunks/Layout_DKjpLSKR.mjs';
...
</p> <!-- Divider --> <div class="divider"></div> <!-- Action Buttons --> <div class="flex gap-4 justify-center flex-wrap mt-8"> <a href="/" class="btn btn-primary rounded-full gap-2"> ${renderComponent($$result2, "House", House, { "class": "size-5" })}
Go Home
</a> <button onclick="history.back()" class="btn btn-outline rounded-full gap-2"> ${renderComponent($$result2, "ArrowLeft", ArrowLeft, { "class": "size-5" })}
Go Back
</button> </div> <!-- Note about SSR --> <div class="mt-12 p-6 bg-base-200 rounded-2xl"> <p class="text-sm text-base-content/60"> <strong>Note:</strong> This error page is only active when using Server-Side
...
}, "/home/farzad/portfolio/src/pages/500.astro", void 0);

const $$file = "/home/farzad/portfolio/src/pages/500.astro";
const $$url = "/500";
