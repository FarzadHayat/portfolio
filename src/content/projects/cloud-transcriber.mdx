...
skills: ['AWS', 'Nginx', 'Express', 'Node.js', 'Terraform', 'Cloud Computing', 'Microservices', 'Whisper ASR', 'FFmpeg']
---
...
![Application Architecture](../../assets/projects/cloud-transcriber/application-architecture.webp)
