...
<figure class="mb-8">
  ...
  <figcaption class="text-sm text-center mt-2">*Verifiers confirm a credential is valid and belongs to the expected holder by checking on-chain records.*</figcaption>
</figure>
